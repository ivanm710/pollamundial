...
// ── MATCHES TAB ───────────────────────────────────────────────────────────────
function MatchesTab({results,koResults,predictions,participants,manualThirdGroups=[]}){
  ...
  return(
    <div style={S.app}>
      ...
      <div style={S.con}>
        ...
        {tab==='matches'&&<MatchesTab results={results} koResults={koResults} predictions={predictions} participants={participants} manualThirdGroups={manualThirdGroups}/>}
