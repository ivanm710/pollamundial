...
function BracketView({bracket,koPicks,koResults,onKoPick,isLocked,readOnly}){
  ...
  function BCard({mid,x,y}){
    ...
    return <div style={{position:'absolute',left:x,top:y,width:BW,border:'1px solid '+(picked?GLD+'77':result?'#3ddc8477':'#1e3a5a'),borderRadius:4,overflow:'hidden',background:'#0a1827',boxShadow:'0 2px 6px #00000060',zIndex:2}}>
