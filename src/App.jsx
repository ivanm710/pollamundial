...
function buildR32(picks){
  ...
  // Backtracking: guarantees valid assignment when greedy fails
  ...
  function assignThirds(idx,usedGroups){
    ...
    for(const c of candidates){
      usedGroups.add(c.group); asgn[slot]=fl(c)
      if(assignThirds(idx+1,usedGroups)) return true
      usedGroups.delete(c.group); delete asgn[slot]
    }
    return false
  }
  assignThirds(0,new Set())
  // Fill any remaining unassigned slots with TBD
